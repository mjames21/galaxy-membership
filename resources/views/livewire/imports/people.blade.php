<div class="max-w-xl mx-auto p-6">
    <h1 class="text-xl font-semibold mb-4">Import: People</h1>
    ...
    <form wire:submit.prevent="import" class="bg-white border rounded p-4 space-y-4" enctype="multipart/form-data">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">CSV (UTF-8). We’ll validate and log results.</p>
        </div>
    ...
    @if ($report)
        <div class="mt-4 bg-white border rounded p-4">
            <h2 class="font-semibold mb-2">Import Report</h2>
            <pre class="text-xs">{{ json_encode($report, JSON_PRETTY_PRINT) }}</pre>
        </div>
    @endif
</div>
